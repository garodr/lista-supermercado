...
const categorias = {
  "🥛 Lácteos": ["leche", "queso", "yogur litro", "yogur vasito", "manteca"],

  "🥩 Carnicería": ["carne", "pollo", "milanesa", "hamburguesa"],
...
function detectarCategoria(nombre) {
  ...
  for (const categoria in categorias) {
    if (categorias[categoria].some((palabra) => texto.includes(palabra))) {
      return categoria;
    }
  }
...
export default function App() {
  ...
  const confirmarCompra = () => {
    ...
    const item = nuevaLista.splice(productoSeleccionado, 1)[0];
  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto relative">
        ...
        <div
          className={`backdrop-blur-xl shadow-2xl rounded-3xl p-6 mb-6 relative z-50 border transition-colors duration-500 ${
            modoOscuro
        ...
        <div
          className={`backdrop-blur-xl shadow-xl rounded-3xl p-3 mb-6 flex gap-2 relative z-10 border transition-colors duration-500 ${
            modoOscuro
              ? "bg-white/10 border-white/10"
        ...
        {Object.entries(
          ...
          <div key={categoria}>
            <div
              className={`text-xl font-black mt-6 mb-2 px-1 ${
      ...
      {modalAbierto && (
        <div className="fixed inset-0 z-[100] bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          >
            <h2 className="text-2xl font-black mb-5">Confirmar compra</h2>
      ...
      {modalAcercaDe && (
        <div className="fixed inset-0 z-[120] bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          >
            <h2 className="text-2xl font-black mb-4">ℹ️ Acerca de</h2>

            <p className="text-lg leading-relaxed">
              Desarrollado por
              <strong> Betelgeuse Software</strong>
            </p>
